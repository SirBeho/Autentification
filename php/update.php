...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    $file_name = $file_error == 0 ? "photo_".$user_id : null;
    ...
    if ($mysqli->query($query) === true and $file_error === 0) {
        ...
        if($file_error === 0){
            $_SESSION['error_message'] = "Error al actualizar los datos: " . $mysqli->error;
        }else{
            $_SESSION['error_message'] = Error_File($file_error);
        }
